...
export default async function PostulacionDetailPage({ params }: PostulacionDetailPageProps) {
            ...
            <CardContent>
              <div className="flex items-center gap-3">
                <Avatar className="h-10 w-10">
                  <AvatarImage src={application.recruiter.avatar} alt={application.recruiter.name} />
                  <AvatarFallback>{application.recruiter.name.charAt(0)}</AvatarFallback>
                </Avatar>
                <div>
                  <p className="font-medium">{application.recruiter.name}</p>
                  <p className="text-xs text-muted-foreground">{application.recruiter.position}</p>
                </div>
              </div>
            </CardContent>
          </Card>
